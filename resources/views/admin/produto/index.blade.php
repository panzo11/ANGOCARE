...
<div class="content-inner container-fluid pb-0" id="page_layout">
          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   <h4 class="card-title">Requisições por Produtos</h4>
                </div>
                <div>
                    <a href="{{ route('produto.create') }}" class="btn btn-primary mt-2" >Cadastrar Utilizador
             ...
             <div class="card-body">
                ...
                <div class="table-responsive">
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$produto->id}}</td>
                            <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{ asset( $produto->capa) }}" alt="profile" loading="lazy"></td>
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$produto->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-primary rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl-video{{$produto->id}}"  >
                                    <span class="btn-inner">
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('produto.delete', $produto->id)}}"">
                                    <span class="btn-inner">
                                 ...
                                 @if($produto->estado==0)
                                 <a class="btn btn-sm btn-icon btn-success rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Aprovar" href="{{route('produto.activar', $produto->id)}}">
                                    <span class="btn-inner">
                           ...
                           <path fill-rule="evenodd" clip-rule="evenodd" d="M11.7281 21.9137C11.8388 21.9715 11.9627 22.0009 12.0865 22C12.2103 21.999 12.3331 21.9686 12.4449 21.9097L16.0128 20.0025C17.0245 19.4631 17.8168 18.8601 18.435 18.1579C19.779 16.6282 20.5129 14.6758 20.4998 12.6626L20.4575 6.02198C20.4535 5.25711 19.9511 4.57461 19.2082 4.32652L12.5707 2.09956C12.1711 1.96424 11.7331 1.96718 11.3405 2.10643L4.72824 4.41281C3.9893 4.67071 3.496 5.35811 3.50002 6.12397L3.54231 12.7597C3.5554 14.7758 4.31448 16.7194 5.68062 18.2335C6.3048 18.9258 7.10415 19.52 8.12699 20.0505L11.7281 21.9137ZM10.7836 14.1089C10.9326 14.2521 11.1259 14.3227 11.3192 14.3207C11.5125 14.3198 11.7047 14.2472 11.8517 14.1021L15.7508 10.2581C16.0438 9.96882 16.0408 9.50401 15.7448 9.21866C15.4478 8.9333 14.9696 8.93526 14.6766 9.22454L11.3081 12.5449L9.92885 11.2191C9.63186 10.9337 9.15467 10.9367 8.8607 11.226C8.56774 11.5152 8.57076 11.98 8.86775 12.2654L10.7836 14.1089Z" fill="currentColor"></path>
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Aprovar" href="{{route('produto.desativar', $produto->id)}}">
                                   <span class="btn-inner">
                          ...
                          <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Desativar" href="{{route('produto.desativar', $produto->id)}}">
                             <span class="btn-inner">
                ...
                <div class="modal fade bd-example-modal-xl{{$produto->id}}" tabindex="-1" role="dialog"   aria-hidden="true">
                 ...
                 <div class="modal fade bd-example-modal-xl-video{{$produto->id}}"  tabindex="-1" role="dialog"   aria-hidden="true">
                  <div class="modal-dialog modal-xl">
                     <div class="modal-content">
                        <div class="modal-header">
                           <h5 class="modal-title">Modal title</h5>
                        ...
                        <div class="modal-body">
                          <form action="{{route('produto.video.update',$produto->id)}}" method="post" enctype="multipart/form-data">
                              @csrf
                       
                              <div class="form-group col-md-6">
                                 <label for="capa">Video</label>
                                 <input type="file" id="video" class="form-control" name="video" placeholder="video"
                                     value="{{ isset($produto->video) ? $produto->video : '' }}">
                             </div>
                              <div class="modal-footer">
                                  <button type="button" class="btn  btn-secondary" data-dismiss="modal">Fechar</button>
                                  <button  class="btn  btn-primary" id="ajaxSubmit" >Cadastrar</button>
 ...
 @if (session('store'))
     <script>
         Swal.fire(
             'Requisização por Recursos Materiais realizado com sucesso!',
             '',
             'success'
         )
     </script>
 ...
 <script>
     Swal.fire(
         'Error ao realizar requisição por Recursos Materiais!',
         '',
         'error'
     )
 </script>
 ...
 @if (session('update'))
     <script>
         Swal.fire(
             'Requisização por Recursos Materiais atualizada com sucesso!',
             '',
             'success'
         )
     </script>
 ...
 <script>
     Swal.fire(
         'Error ao atualizar requisição por Recursos Materiais!',
         '',
         'error'
     )
 </script>
 ...
 @if (session('delete'))
     <script>
         Swal.fire(
             'Requisização por Recursos Materiais eliminada com sucesso!',
             '',
             'success'
         )
     </script>
 ...
 <script>
     Swal.fire(
         'Error ao eliminar requisição por Recursos Materiais!',
         '',
         'error'
     )
 </script>
 ...
 @if (session('on'))
     <script>
         Swal.fire(
             'Requisização por Recursos Materiais aprovada com sucesso!',
             '',
             'success'
         )
     </script>
 ...
 <script>
     Swal.fire(
         'Error ao aprovar requisição por Recursos Materiais!',
         '',
         'error'
     )
 </script>
 ...
 @if (session('off'))
     <script>
         Swal.fire(
             'Requisização por Recursos Materiais rejeitada com sucesso!',
             '',
             'success'
         )
     </script>
 ...
 <script>
     Swal.fire(
         'Error ao rejeitar requisição por Recursos Materiais!',
         '',
         'error'
     )
 </script>
 ...
 @if (session('video'))
     <script>
         Swal.fire(
             'Video vinculado a Requisização por Recursos Materiais com sucesso!',
             '',
             'success'
         )
     </script>
 ...
 <script>
     Swal.fire(
         'Error ao vincular video a requisição por Recursos Materiais!',
         '',
         'error'
     )
 </script>
