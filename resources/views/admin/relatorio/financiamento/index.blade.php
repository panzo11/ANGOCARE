          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   <h4 class="card-title">Causas Financeiras</h4>
                </div>
                <div>
             ...
             <div class="card-body">
               ...
               <form action="{{route('relatorio.financiamento.request')}}" method="post" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                @foreach ($financiamentos as $financiamento)
                                    ...
                                    <option value="{{ $financiamento->titulo }}">{{ $financiamento->titulo }}</option>
                           ...
                           <div class="form-group col-md-6">
                                <label for="inputState">Categoria da Causa</label>
                                <select id="categorias" class="form-control" name="categorias" style="width: 100%;" >
                                <option value="" >Todos</option>
                                @foreach ($financiamentos as $financiamento)

                                    <option value="{{ $financiamento->categoria }}">{{ $financiamento->categoria }}</option>
