          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   <h4 class="card-title">Causas de Recursos Materias</h4>
                </div>
                <div>
                    <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-xl">Recursos Matérias
             ...
             <div class="card-body">
               ...
               <form action="{{route('relatorio.produto.request')}}" method="post" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                @foreach ($produtos as $produto)
                                    ...
                                    <option value="{{ $produto->titulo }}">{{ $produto->titulo }}</option>
